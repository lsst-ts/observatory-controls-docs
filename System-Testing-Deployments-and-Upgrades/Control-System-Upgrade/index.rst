...
Since the control system is highly coupled to the interface specification (XML), the communication backplane (Kafka) and the abstraction layer (SAL), this documentation focuses on upgrades to those dependencies.
